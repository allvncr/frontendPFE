                ...
                <div class="secondary">
                  <div class="d-block">
                    <div class="widget-head">
                      <a>
                        <h3 @click="cat = !cat">Categories</h3>
                        <div>
                          <font-awesome-icon :icon="[ 'fas', 'plus' ]" @click="cat = !cat" v-show="cat==false"/>
                          <font-awesome-icon :icon="[ 'fas', 'minus' ]" @click="cat = !cat" v-show="cat==true"/>
                        </div>
                      </a>
                    </div>

                    <div class="woocommerce" v-show="cat==true">
                      <ul>
                  ...
                  <div class="d-block">
                    <div class="widget-head">
                      <a>
                        <h3 @click="author = !author">Author</h3>
                        <div>
                          <font-awesome-icon :icon="[ 'fas', 'plus' ]" @click="author = !author" v-show="author==false"/>
                          <font-awesome-icon :icon="[ 'fas', 'minus' ]" @click="author = !author" v-show="author==true"/>
                        </div>
                      </a>
                    </div>
                    <div class="woocommerce" v-show="author===true">
                      <ul>
...
export default {
  ...
  methods: {
    ...
    button(){
      this.nbre = this.total/this.perPage
    ...
    paginate(){
      this.pagination = this.books.slice(0, this.perPage)
    },
  ...
  mounted(){
    this.getAll(this.$route.params.cat)
    this.getCat()
  },
